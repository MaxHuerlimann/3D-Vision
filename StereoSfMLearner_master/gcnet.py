...
def stereo_model(left_x, right_x, max_disparity, is_training=False, rv=None):
    c = Config()
    ...
    with tf.variable_scope('stereo_network', reuse=rv):
        ...
        # Cost Volume
        CostVol_left = getCostVolume(left_features, right_features, max_disparity / 4)
