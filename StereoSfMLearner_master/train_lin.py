...
flags = tf.app.flags
flags.DEFINE_string("dataset_dir", "/cluster/scratch/maxh/formatted_dataset", "Dataset directory")
...
flags.DEFINE_integer("max_steps", 200, "Maximum number of training iterations")
