...
\newcommand{\memberonepicture}{IsaakNoah.jpg}
\newcommand{\membertwo}{Max Huerlimann}
\newcommand{\membertwopicture}{HuerliMax.jpg}
...
\begin{tabular}{ | l | l | l | }
    \hline
    \textbf{Workpackage} & \textbf{Timeframe} & \textbf{Supervised by} \\ \hline
    Getting familiar with existing code & 12/03 - 17/03 & Max \& Noah \\ \hline
    Adaptation of Dispnet & 18/03 - 21/03 & Noah \\ \hline
    Design of pose estimation network & 21/03 - 07/04 & Max \\ \hline
    Training of the network on KITTI dataset & 08/04 - 01/05 & Max \& Noah \\ \hline
    Validation of network & 02/05 - 15/05 & Max \& Noah \\ \hline
\end{tabular}
\\[10pt]
